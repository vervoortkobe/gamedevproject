...
namespace gamedevproject.ScreenClasses
{
    public class GameOverScreen: IScreen
    {
        ...
        public GameOverScreen(ContentManager Content, GameStateManager gsman, GameState gameState, SpriteBatch spriteBatch)
        {
            _gsman = gsman;
            _gameState = gameState;
            _spriteBatch = spriteBatch;
            _texture = Content.Load<Texture2D>("Backgrounds/extra2");
            _text = Content.Load<Texture2D>("Backgrounds/gameover2");
        }
